...
function openEditTaskModal(task) {
  ...
  const saveButton = modal.querySelector('save-task-changes-btn');
  const deleteTaskBtn = modal.getElementById('delete-task-btn');
  cancelEditBtn = modal.getElementById("cancel-edit-btn");
